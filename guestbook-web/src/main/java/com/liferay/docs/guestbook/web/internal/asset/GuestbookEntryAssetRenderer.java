...
public class GuestbookEntryAssetRenderer extends BaseJSPAssetRenderer<GuestbookEntry> {
    ...
    public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
        ...
        portletURL.getRenderParameters().setValue("mvcPath", "/guestbook/edit_entry.jsp");
        portletURL.getRenderParameters().setValue("entryId", String.valueOf(_entry.getEntryId()));
    ...
    public String getURLViewInContext(LiferayPortletRequest liferayPortletRequest,
        ...
        try {
            ...
            portletURL.getRenderParameters().setValue("mvcPath", "/guestbook/view_entry.jsp");
            portletURL.getRenderParameters().setValue("entryId", String.valueOf(_entry.getEntryId()));
