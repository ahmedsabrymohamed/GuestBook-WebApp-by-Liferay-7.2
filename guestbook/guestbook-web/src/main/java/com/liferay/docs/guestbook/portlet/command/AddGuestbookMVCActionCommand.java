...
property= {
		...
		"mvc.command.name=addGuestbook"
},service =MVCActionCommand.class)
public class AddGuestbookMVCActionCommand extends BaseMVCActionCommand {

	private static final Logger logger = LoggerFactory.getLogger(AddGuestbookMVCActionCommand.class);
	@Reference
