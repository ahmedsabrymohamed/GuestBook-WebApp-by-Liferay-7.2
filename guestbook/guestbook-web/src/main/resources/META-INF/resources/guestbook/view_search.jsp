...
<%
	...
	for (int i = 0; i < hits.getDocs().length; i++) {
		...
		try {
			...
			_log.error(pe.getLocalizedMessage(),pe);
		} catch (SystemException se) {
			_log.error(se.getLocalizedMessage(),se);
		}
...
<%!private static final Logger _log = LoggerFactory.getLogger("html.guestbook.view_search_jsp");%>